...
fn test_tx_trie() {
    ...
    let write_set1_trie: TxTrie = write_set1_trie.into();
    ...
    let write_set2_trie: TxTrie = write_set2_trie.into();
    ...
    let write_set3_trie: TxTrie = write_set3_trie.into();
    ...
    let write_set4_trie: TxTrie = write_set4_trie.into();
